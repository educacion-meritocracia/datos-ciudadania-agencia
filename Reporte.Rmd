...
```{r opciones globales, warning=FALSE, cache=FALSE, include=FALSE, results="asis"}
...
#Correlaciones padre e hijo
pairs.panels(paz[1:2], hist.col="gray", digit=2, stars = TRUE)
pairs.panels(paz[3:4], hist.col="gray", digit=2, stars = TRUE)
pairs.panels(paz[5:6], hist.col="gray", digit=2, stars = TRUE)
pairs.panels(paz[7:8], hist.col="gray", digit=2, stars = TRUE)
